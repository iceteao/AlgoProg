...
public class Dijkstra {
	...
	private static ArrayList<String> shortestPathList = new ArrayList<String>();
	...
	public static ArrayList<String> Dijkstra(String filename, String source, String destination) {
		...
		for (int i = 2; i < workStationsList.size(); i = i + 3) {
